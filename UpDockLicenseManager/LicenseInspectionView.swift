  ...
  var body: some View {
    VStack(alignment: .leading, spacing: 18) {
      ...
      Group {
        ...
        row("License Kind", inspection.licenseFile.license.licenseKind)
        row("Product", inspection.licenseFile.license.product)
        row("Bundle ID", inspection.licenseFile.license.bundleID)
        row("Edition", inspection.licenseFile.license.edition)
        row("Customer ID", inspection.licenseFile.license.customerID)
        row("Seat Allowance", "\(inspection.licenseFile.license.seatAllowance)")
